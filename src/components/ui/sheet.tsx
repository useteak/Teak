...
function SheetHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={mergeClassNames('gap-1.5 p-4 flex flex-col', className)}
      {...props}
    />
  )
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={mergeClassNames('gap-2 p-4 mt-auto flex flex-col', className)}
      {...props}
    />
  )
}
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={mergeClassNames('text-foreground font-medium', className)}
      {...props}
    />
  )
}
