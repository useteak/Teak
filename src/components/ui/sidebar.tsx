...
const sidebarMenuButtonVariants = cva(
  'cursor-pointer ring-sidebar-ring hover:bg-sidebar-accent not-data-active:hover:text-sidebar-accent-foreground not-data-active:active:bg-sidebar-accent not-data-active:active:text-sidebar-accent-foreground data-active:bg-sidebar-accent data-active:text-sidebar-accent-foreground data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground gap-2 rounded-md p-2 text-left text-sm transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! focus-visible:ring-2 peer/menu-button flex w-full items-center overflow-hidden outline-hidden disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:text-muted-foreground text-muted-foreground data-active:text-foreground data-active:[&_svg]:text-foreground [&_svg]:shrink-0 data-active:font-medium',
  {
    variants: {
      variant: {
        default:
