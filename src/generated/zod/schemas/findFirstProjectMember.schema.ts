...
export const ProjectMemberFindFirstSelectSchema: z.ZodType<Prisma.ProjectMemberSelect> = z.object({
...
export const ProjectMemberFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    projectId: z.boolean().optional(),
    project: z.boolean().optional(),
    userId: z.boolean().optional(),
