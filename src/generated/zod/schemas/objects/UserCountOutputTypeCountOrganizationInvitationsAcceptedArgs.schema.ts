...
export const UserCountOutputTypeCountOrganizationInvitationsAcceptedArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountOrganizationInvitationsAcceptedArgsObjectZodSchema = makeSchema();
