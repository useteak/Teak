...
export const FeedbackFindFirstSelectSchema: z.ZodType<Prisma.FeedbackSelect> = z.object({
...
export const FeedbackFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    description: z.boolean().optional(),
    type: z.boolean().optional(),
    email: z.boolean().optional(),
...
export const FeedbackFindFirstSchema: z.ZodType<Prisma.FeedbackFindFirstArgs> = z.object({ select: FeedbackFindFirstSelectSchema.optional(), include: z.lazy(() => FeedbackIncludeObjectSchema.optional()), orderBy: z.union([FeedbackOrderByWithRelationInputObjectSchema, FeedbackOrderByWithRelationInputObjectSchema.array()]).optional(), where: FeedbackWhereInputObjectSchema.optional(), cursor: FeedbackWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FeedbackScalarFieldEnumSchema, FeedbackScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FeedbackFindFirstArgs>;

export const FeedbackFindFirstZodSchema = z.object({ select: FeedbackFindFirstSelectSchema.optional(), include: z.lazy(() => FeedbackIncludeObjectSchema.optional()), orderBy: z.union([FeedbackOrderByWithRelationInputObjectSchema, FeedbackOrderByWithRelationInputObjectSchema.array()]).optional(), where: FeedbackWhereInputObjectSchema.optional(), cursor: FeedbackWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FeedbackScalarFieldEnumSchema, FeedbackScalarFieldEnumSchema.array()]).optional() }).strict();